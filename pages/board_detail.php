...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">질문 게시판 관리 페이지</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                	...
                                	{
                                		echo ("<tr><td>$row[bid]</td><td>$row[name]</td><td>$row[title]"." [$row[reply_num]"."]</td><td>$row[time]</td><td><button class='btn btn-default btn-xs' type='button' onClick='reply($row[bid])'>답변</button></td>");
                                	}
                                	mysqli_close($con);
                                	?>
                                </tbody>
    ...
    function reply(bid){
        location.href="board_reply.php?bid="+bid
    }
    </script>
