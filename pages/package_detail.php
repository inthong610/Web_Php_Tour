...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">패키지 관리 페이지</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                	...
                                	include '../DAO.php';
                                	if($_GET['cnid']==null){
                                		$sql = "select * from package , detailcountry WHERE detailcountry.dcid = package.dcid;"; // 모든 memeber 정보 출력
                                	} else{
                                		$cnid = $_GET['cnid'];
                                		$sql = "select * from package , (select * from detailcountry WHERE CNID = $cnid ) as a WHERE a.dcid = package.dcid;";
                                	}
                                	...
                                	{	
                                		...
                                		echo ("<tr><td>$row[Detail_name]</td><td>$row[Product]</td><td>$departure</td><td>$row[Theme]</td><td>$row[Cost]&nbsp;&nbsp;<button class='btn btn-default btn-xs' type='button' onClick='revise_package($row[PID])'>수정</button></td>");
                                	}
                                	mysqli_close($con);
                                	?>
                                </tbody>
    ...
    function revise_package(pid){
        location.href="package_revise.php?pid="+pid
    }
    </script>
