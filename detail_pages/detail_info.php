...
<html lang="en">
  ...
  <body>
    ...
    <!-- Page Header -->
    <header class="masthead" style="background-image: url('img/호텔.jpg')">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 col-md-10 mx-auto">
            ...
            <?php
            $sql2 = "select info, spot_img, hotel_img from packagedetail where pid=$pid;";
            $ret2 = mysqli_query($con, $sql2);
            $row2 = mysqli_fetch_array($ret2);
            ?>
            <div>
              <p>
              <label><strong><font style="font-family: 'Lora';">1. 관광지 사진</font></strong></label>
            </p><p>
              <img class="img-fluid" style="width:400px;height:250px;" src="../<?=$row2[1]?>" alt=""></p>
              <p>
              <label><strong><font style="font-family: 'Lora';">2. 호텔 사진</font></strong></label></p><p>
              <img class="img-fluid" style="width:400px;height:250px;" src="../<?=$row2[2]?>" alt=""></p>
            </div>

            <label><strong><font style="font-family: 'Lora';">3. 호텔과 관광지 정보</font></strong></label>
            <?php
            echo ("<p><font style=\"font-family: 'Lora';\">");
            echo nl2br($row2[0]);
            echo ("</font></p>");
