...
<form align-items:center method="post" action="">
  <header>
    ...
    <div class="imgcontainer">
      <a href="http://localhost"<center><img src="http://imageshack.com/a/img922/8682/OpuU53.png" height=100px width=350px ></center></a>
    </div>
  </header>
 <input type="text" class="textform" placeholder="ID" name="id" id="id" style="margin-bottom: 50px"/>
<input type="password" class="textform"  placeholder="Password" id="pwd" name="pwd" style="margin-bottom: 20px"/>  <div style="float:left; width:50%; height:60px;"><input type="button" class="btn1" onclick value="SignUp"/></div>
