        ...
        <div class="row">
          <div class="col-lg-8 col-md-10 mx-auto">
            <div class="post-heading">
              ...
              session_start();
              $pid_di=$_SESSION['PID'];
              $sql = "select detail_name, product from package as p, detailcountry as d where pid=$pid_di and p.dcid=d.dcid;";
              $ret = mysqli_query($con, $sql);
              while($row = mysqli_fetch_array($ret)){
              echo ("<h1>$row[detail_name]</h1>"); // country_name마다 CNID의 value 하나씩 넣기
              echo("<h2>$row[product] 호텔과 관광지 정보</h2>");
            }
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 col-md-10 mx-auto">
            ...
            <?php
            $sql2 = "select info, schedule from packagedetail where pid=$pid_di;";
            $ret2 = mysqli_query($con, $sql2);
            while($row2 = mysqli_fetch_array($ret2))
          {

            echo ("<p>$row2[info]</p>"); // country_name마다 CNID의 value 하나씩 넣기
